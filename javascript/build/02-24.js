...
var Empolyes = /*#__PURE__*/function (_Person) {
  _inherits(Empolyes, _Person);
  var _super = _createSuper(Empolyes);
  function Empolyes(name, tel, address, empno, dept) {
    var _this;
    _classCallCheck(this, Empolyes);
    _this = _super.call(this, name, tel, address);
    _this.empno = empno;
    _this.dept = dept;
    return _this;
  }
  _createClass(Empolyes, [{
    key: "toString",
    value: function toString() {
      return _get(_getPrototypeOf(Empolyes.prototype), "toString", this).call(this) + ", empno=".concat(this.empno, ", dept=").concat(this.dept);
    }
  }, {
    key: "getEmpInfo",
...
var e1 = new Empolyes("이몽룡", "010-222-2121", "서울시", "A12311", "회계팀");
