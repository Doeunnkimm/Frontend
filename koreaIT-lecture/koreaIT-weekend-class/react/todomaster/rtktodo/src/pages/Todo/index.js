...
function TodoPage() {
	...
	const todoList = useSelector(state => state.todo.todos) // 초기값 가져옴
	const state = useSelector(state => state.todo.addTodoState)
	const dispatch = useDispatch()

	const onOpenFormModal = () => setIsOpenAddTodoModal(true)
	const onCloseFormModal = () => setIsOpenAddTodoModal(false)
