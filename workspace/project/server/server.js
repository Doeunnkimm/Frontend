...
app.get("/api/hello", (req, res) => {
  console.log(
    "--------------------> [GET]  /api/hello call req.query로 데이터를 가져온다."
  );
  console.log("서버에서 데이터를 가져온다.");
...
app.delete("/api/hello", (req, res) => {
  console.log(
    "--------------------> [DELETE]  /api/hello call req.query로 데이터를 가져온다."
  );
  console.log("서버에서 데이터를 삭제한다.");
  console.log(req.query);
  res.send("[DELETE] 서버에서 데이터를 삭제한다.");
...
app.post("/api/hello", (req, res) => {
  console.log(
    "--------------------> [POST]  /api/hello call req.body로 데이터를 가져온다."
  );
  console.log("서버에서 데이터를 삽입한다.");
...
app.put("/api/hello", (req, res) => {
  console.log(
    "--------------------> [PUT]  /api/hello call req.body로 데이터를 가져온다."
  );
  console.log("서버에서 데이터를 수정한다.");
  console.log(req.body);
  res.send("[PUT] 서버에서 데이터를 수정한다.");
...
// const SpreadExam = require("./src/Day05/SpreadExam");
// SpreadExam.exam01();
// SpreadExam.exam02();
// SpreadExam.exam03();
